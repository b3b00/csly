...
namespace ParserTests
{
    public class PostProcessedLexerTests
    {
        ...
        [Fact]
        public void TestGeneratedPostLexerProcessing()
        {
            PostProcessedLexerGenerator generator = new PostProcessedLexerGenerator();
            var parserRes = generator.GetParser($"{nameof(FormulaParser)}_expressions");

...
#region VALUES
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("0.1");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsValue);
        ...
        public void TestStringValue()
        {
            ...
            ParseResult<JsonToken,JSon> r = Parser.Parse("\"" + val + "\"");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsValue);
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("true");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsValue);
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("false");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsValue);
            JValue val = ((JValue)r.Result);
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("null");            
            Assert.False(r.IsError);
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("{}");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("{\"prop\":\"value\"}");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsObject);
        ...
        public void TestManyPropertyObjectValue()
        {
            ...
            json = "{\"p1\":\"v1\" , \"p2\":\"v2\" }";
            ParseResult<JsonToken,JSon> r = Parser.Parse(json);
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsObject);
            JObject values = (JObject)r.Result;
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("[1,2]");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.True(r.Result.IsList);
            JList list = (JList) r.Result;
        ...
        {
            ParseResult<JsonToken,JSon> r = Parser.Parse("[1,null,{},true,42.58]");
            Assert.False(r.IsError);
            Assert.NotNull(r.Result);
            Assert.NotNull(r.Result);
            object val = r.Result;

...
namespace BenchCslies.parsers.json.csly
{
    [BroadenTokenWindow]
    [ParserRoot("root")]
    [FirstDerivation]
    public class CslyEbnfJsonGenericParser
    {
        #region root
        ...
        public JSon StringValue(Token<CslyJsonTokenGeneric> stringToken)
        {
            return new JValue(stringToken.StringWithoutQuotes);
        }

        [Production("value : INT")]
        public JSon IntValue(Token<CslyJsonTokenGeneric> intToken)
        {
            return new JValue(intToken.IntValue);
        }

        [Production("value : DOUBLE")]
        public JSon DoubleValue(Token<CslyJsonTokenGeneric> doubleToken)
        {
            double dbl;
            try
            {
        ...
        public JSon BooleanValue(Token<CslyJsonTokenGeneric> boolToken)
        {
        ...
        public JSon ListElementsOne(Token<CslyJsonTokenGeneric> discardedComma, JSon value)
        {
            return value;
        }
        ...
        public JSon property(Token<CslyJsonTokenGeneric> key, JSon value)
        {

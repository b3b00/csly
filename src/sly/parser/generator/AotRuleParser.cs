...
public class AotRuleParser<IN,OUT> where IN: struct
{
    ...
    public Parser<EbnfTokenGeneric, GrammarNode<IN, OUT>> BuildParser(string i18N)
    {
        RuleParser<IN, OUT> instance = new RuleParser<IN, OUT>();
        IAotParserBuilder<EbnfTokenGeneric, GrammarNode<IN,OUT>> builder = AotParserBuilder<EbnfTokenGeneric, GrammarNode<IN,OUT>>.NewBuilder<EbnfTokenGeneric, GrammarNode<IN,OUT>>(instance, "rule", i18N);
        ...
        builder = builder.Production("rule : IDENTIFIER COLON clauses", (args =>
            ...
            .Production("clauses : clause clauses", (args =>
            {
                return instance.Clauses((IClause<IN, OUT>)args[0], (ClauseSequence<IN, OUT>)args[1]);
            }))
            .Production("clauses : clause", (args =>
            {
                return instance.SingleClause((IClause<IN, OUT>)args[0]);
            }))
            .Production("clause : IDENTIFIER ZEROORMORE", (args =>
            {
                return instance.ZeroMoreClause((Token<EbnfTokenGeneric>)args[0], (Token<EbnfTokenGeneric>)args[1]);
            }))
            .Production("clause : IDENTIFIER ONEORMORE", (args =>
            {
                return instance.OneMoreClause((Token<EbnfTokenGeneric>)args[0], (Token<EbnfTokenGeneric>)args[1]);
            }))
            .Production("clause : IDENTIFIER OPTION", (args =>
            {
                return instance.OptionClause((Token<EbnfTokenGeneric>)args[0], (Token<EbnfTokenGeneric>)args[1]);
            }))
            .Production("clause : IDENTIFIER ", (args =>
            {
                return instance.SimpleClause((Token<EbnfTokenGeneric>)args[0]);
            }))
            .Production("clause : STRING ", (args =>
            {
                return instance.ExplicitTokenClause((Token<EbnfTokenGeneric>)args[0]);
            }))
            ...
            .Production("choices : IDENTIFIER", (args =>
            {
                return instance.ChoicesOne((Token<EbnfTokenGeneric>)args[0]);
            }))
            .Production("choices : STRING", (args =>
            {
                return instance.ChoicesString((Token<EbnfTokenGeneric>)args[0]);
            }))
            ...
            .Production("groupclause : STRING", (args =>
            {
                return instance.GroupClauseExplicit((Token<EbnfTokenGeneric>)args[0]);
            }))
            ...
            .Production("groupclause : choiceclause", (args =>
            {
                return instance.GroupChoiceClause((ChoiceClause<IN, OUT>)args[0]);
            }))
            .Production("groupclauses : groupclause", (args =>
            {
                return instance.GroupClausesOne((GroupClause<IN, OUT>)args[0]);
            }))
            .Production("groupclauses : groupclause groupclauses", (args =>
            {

...
public class PrefixExpressionStackState<IN,OUT> : EbnfStackState<IN,OUT> where IN : struct, Enum
{
    ...
    public override EbnfStackStateType EbnfStackType => EbnfStackStateType.Prefix;

...
namespace sly.parser
{
    public class UnexpectedTokenSyntaxError<T> : ParseError, IComparable where T : struct
    {
        ...
        private  Dictionary<T, Dictionary<string, string>> _labels = new Dictionary<T, Dictionary<string, string>>();
        ...
        public void Init(Token<T> unexpectedToken, Dictionary<T, Dictionary<string, string>> labels, string i18n=null, params LeadingToken<T>[] expectedTokens )
        {
            _labels = labels;
            _i18N = i18n;
            ErrorType = unexpectedToken.IsEOS ? ErrorType.UnexpectedEOS : ErrorType.UnexpectedToken;
        ...
        public UnexpectedTokenSyntaxError()
        {
            ExpectedTokens = new List<LeadingToken<T>>();

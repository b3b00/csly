...
public class FluentParserBuilder<IN, OUT> : IFluentParserBuilder<IN,OUT> where IN : struct
{
    ...
    public static IFluentParserBuilder<IN,OUT> NewBuilder(object parserInstance, string rootRule, string i18N = "en") 
    {
        return new FluentParserBuilder<IN,OUT>(i18N, parserInstance, rootRule);
    }
    
    private FluentParserBuilder(string i18N, object parserInstance, string rootRule)
    {
        _i18N = i18N;
    ...
    public IFluentParserBuilder<IN, OUT> UseMemoization(bool use = true)
    {
        _useMemoization = use;
        return this;
    }

    public IFluentParserBuilder<IN, OUT> UseBroadenTokenWindow(bool use = true)
    {
        _useBroadenTokenWindow = use;
        return this;
    }

    public IFluentParserBuilder<IN, OUT> UseAutoCloseIndentations(bool use = true)
    {
    ...
    public IFluentParserBuilder<IN, OUT> Production(string ruleString, Func<object[], OUT> visitor)
    {

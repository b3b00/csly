...
public class FluentLexerBuilder<IN> :  IFluentLexemeBuilder<IN> where IN : struct
{
    ...
    public static IFluentLexerBuilder<IN> NewBuilder() 
    {
        return new FluentLexerBuilder<IN>();
    }

    
    
    private FluentLexerBuilder()
    {
    ...
    public IFluentLexemeBuilder<IN> WithLabel(string lang, string label)
    {
    ...
    public IFluentLexemeBuilder<IN> WithLabels(params (string lang, string label)[] labels)
    {
        (List<LexemeAttribute> lexeme, List<LexemeLabelAttribute> labels) currentLexeme;
        if (!_lexemesDefinitionsAndLabels.TryGetValue(_currentLexeme.Value, out currentLexeme))
        {
    ...
    public IFluentLexemeBuilder<IN> WithModes(params string[] modes)
    {
    ...
    public IFluentLexemeBuilder<IN> OnChannel(int channel)
    {
    ...
    public IFluentLexemeBuilder<IN> PopMode()
    {
        _modePopers.Add(_currentLexeme.Value);
        return this;
    }

    public IFluentLexemeBuilder<IN> PushToMode(string targetMode)
    {

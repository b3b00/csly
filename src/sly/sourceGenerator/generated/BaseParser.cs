...
public class BaseParser<TIn, TOut> where TIn : struct
{
    ...
    protected SimpleParser<TIn, TOut> DiscardedTerminalParser(string nodeName = null,
        Func<object[], TOut> visitor = null, params TIn[] expectedTokens)
    {
    ...
    protected SimpleParser<TIn, TOut> TerminalParser(string nodeName = null, Func<object[], TOut> visitor = null,
        params TIn[] expectedTokens)
    {
        return (tokens, position) =>
        {
            if (position >= tokens.Count)
...
// many values
    ...
    protected SimpleParser<TIn, TOut> OneOrMoreValue(SimpleParser<TIn, TOut> repeatedParser)
    {
        SimpleParser<TIn, TOut> oneOrMore = (IList<Token<TIn>> tokens, int position) =>
        {
            int currentPosition = position;
...
// many tokens
    ...
    protected SimpleParser<TIn, TOut> OneOrMoreToken(string name, IList<Token<TIn>> tokens, int position,
        SimpleParser<TIn, TOut> repeatedParser)
    {
        SimpleParser<TIn, TOut> oneOrMore = (IList<Token<TIn>> tokens, int position) =>
        {
            int currentPosition = position;

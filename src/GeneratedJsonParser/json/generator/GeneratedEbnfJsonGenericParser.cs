...
using csly.GeneratedJsonParser.generatedebnfjsongenericparser.models;


namespace generatedJsonParser;


[ParserRoot("root")]
public class GeneratedEbnfJsonGenericParser
{
    #region root
    ...
    public JSon StringValue(Token<GeneratedCslyJsonTokenGeneric> stringToken)
    {
        return new JValue(stringToken.StringWithoutQuotes);
    }

    [Production("value : INT")]
    public JSon IntValue(Token<GeneratedCslyJsonTokenGeneric> intToken)
    {
        return new JValue(intToken.IntValue);
    }

    [Production("value : DOUBLE")]
    public JSon DoubleValue(Token<GeneratedCslyJsonTokenGeneric> doubleToken)
    {
        double dbl;
        try
        {
    ...
    public JSon BooleanValue(Token<GeneratedCslyJsonTokenGeneric> boolToken)
    {
    ...
    public JSon AttributesObjectValue(JSon members)
    {
        return members;
    }
    ...
    public JSon List(JSon elements)
    {
        return elements;
    }
    ...
    public JSon ListElementsOne(Token<GeneratedCslyJsonTokenGeneric> discardedComma, JSon value)
    {
        return value;
    }
    ...
    public JSon Members(JSon head, List<JSon> tail)
    {
        var value = new JObject();
        value.Merge(head as JObject);
        foreach (var p in tail) value.Merge((JObject) p);
        return value;
    }

    [Production("additionalProperty : COMMA[d] property")]
    public JSon property( JSon property)
    {
        return property;
    }

    [Production("property: STRING COLON[d] value")]
    public JSon property(Token<GeneratedCslyJsonTokenGeneric> key, JSon value)
    {
